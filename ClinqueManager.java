...
public class ClinqueManager {
		...
		public void searchDoctor()
		{
			...
			public void appointmentofDoctor()
			{
				...
				//Date optimizing according to user input//
				System.out.println("Enter Date for which you need appointment in this format: dd/MM/yyyy");
				String stringDate = sc.next();
				DateFormat df = new SimpleDateFormat("dd/MM/yyyy");
				Date dateobj1 = new Date();
				try {
					dateobj1 = df.parse(stringDate);
		       ...
		       /*getting current date time using calendar class 
				...
				try{
					...
					for (int i = 0; i < appointmentFileObj.size(); i++)
					{
						...
						if(doctorName.equals(doc) && date.equals(stringDate) )
						{
							count++;
						}
					}
	...
	public static void main(String [] args)
	{
		...
		ClinqueManager v = new ClinqueManager();
		Scanner sc = new Scanner(System.in);
